    ...
    <>
      <div className="flex justify-center w-full mb-6">
        <div className="relative">
          <img
            src={`${user?.avatar?.url}`}
            className="w-[150px] h-[150px] rounded-full object-cover border-[3px] border-blue-900"
            alt="User Avatar"
          />
          <div className="w-[30px] h-[30px] bg-blue-900 rounded-full flex items-center justify-center cursor-pointer absolute bottom-[5px] right-[5px]">
            <input
              type="file"
              id="image"
              className="hidden"
      ...
      <div className="w-full px-5">
        <form onSubmit={handleSubmit} aria-required={true}>
          ...
          <div className="flex justify-center pt-4">
            <input
              className="w-[250px] h-[40px] bg-blue-900 font-bold text-yellow-600 text-center rounded-md mt-4 cursor-pointer hover:bg-blue-700 transition"
              required
              value="Update"
              type="submit"
            />
